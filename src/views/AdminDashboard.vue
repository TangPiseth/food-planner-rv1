          ...
          <div v-for="review in pendingReviews" :key="review._id" class="review-card mb-3">
            <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
              <div class="flex-grow-1">
                ...
                <div class="text-muted small mb-2">{{ review.email }} • Recipe: {{ review.recipeId }}</div>
          ...
          <div v-for="report in pendingReports" :key="report._id" class="review-card mb-3">
            <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
              <div class="flex-grow-1">
                ...
                <div class="small text-muted">By {{ report.reviewId?.name || '-' }} ({{ report.reviewId?.rating || '-' }}/5)</div>
              </div>
              <div class="d-flex flex-column gap-2">
